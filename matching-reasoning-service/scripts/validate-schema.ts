...
const EXPECTED_TABLES: ExpectedTable[] = [
  ...
  },
  {
    ...
    columns: [
      { name: 'id', dataType: 'integer', nullable: false },
      { name: 'from_skill_id', dataType: 'integer', nullable: false },
      { name: 'to_skill_id', dataType: 'integer', nullable: false },
      { name: 'relationship_type', dataType: 'character varying', nullable: false },
      { name: 'weight', dataType: 'numeric', nullable: false },
      { name: 'source', dataType: 'character varying', nullable: false },
      { name: 'created_at', dataType: 'timestamp without time zone', nullable: false },
    ],
  },
...
const EXPECTED_INDEXES: string[] = [
  'idx_skill_nodes_category',
  'idx_skill_nodes_aliases',
  'idx_skill_edges_from',
  'idx_skill_edges_to',
  'idx_reasoning_conclusions_subject',
  'idx_reasoning_conclusions_type',
];
