 ...
 * (byte-identical), the single function semanticReasoning.ts's embedding-neighbor tier needs.
 * Calls python-services/matching-ml-service directly, never through the monolith - same as
 * matching-evaluation-service's own copy of this client (Batch 24).
 */
