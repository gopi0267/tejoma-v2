// Ported byte-identical from the monolith's src/matching/reasoning/technologyRelationship.ts
// (Batch 26). Enterprise AI Matching Architecture, §5.1 AI Reasoning Layer - Module 5: Technology
