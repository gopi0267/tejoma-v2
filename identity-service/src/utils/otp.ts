// Ported from the monolith's src/utils/otp.ts, now in full - this batch adds the OTP-dependent
// password reset flow, which needs generateOTP/hashOTP/compareOTP alongside normalizeIdentifier.
