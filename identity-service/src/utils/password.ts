// Ported exactly from the monolith's src/utils/password.ts - same library, same thresholds, same
// error message shape, so a password rejected by the monolith today is rejected identically here.
...
// zxcvbn scores 0-4 (worst-best). 2 ("fair") is the standard minimum bar used by most production
// strength meters - 0/1 catches "password123", "qwerty", name/email-based, etc.
