/**
 * Integration tests for the health/readiness/liveness endpoints - mirrors every other DB-owning
 * Tier 0 service's tests/health.routes.test.ts.
 */
...
describe('GET /health', () => {
  it('reports service identity and a timestamp', async () => {
    ...
    expect(res.body.service).toBe('matching-skill-discovery-service');
