/**
 * A real, minimal stand-in for the monolith's /internal/skill-discovery/* API - mirrors
 * matching-reasoning-service's/matching-evaluation-service's tests/helpers/mockMonolith.ts (real
 * HTTP on a real ephemeral port, not a mock of `fetch`).
 */
