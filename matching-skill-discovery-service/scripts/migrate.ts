/**
 * Migration runner for Matching Skill Discovery Service's database. Mirrors every other Tier 0
  ...
  if (!confirmed) {
    console.error(
      'Refusing to run a rollback migration without --confirm. This is a destructive operation ' +
        'that may delete real data once this database holds real discovery proposals - see ' +
