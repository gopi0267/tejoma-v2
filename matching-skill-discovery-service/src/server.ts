/**
 * Matching Skill Discovery Service Express app - Tier 0 (Batch 27). Mirrors every other Tier 0
...
import skillDiscoveryRoutes from './routes/skillDiscovery.routes.js';
...
app.use('/api', skillDiscoveryRoutes);
