/**
 * Staff auth verification for Matching Skill Discovery Service - verifies the exact token
 ...
 * matching-evaluation-service's/jd-parser-service's/chat-service's auth.middleware.ts - see
 * config/env.ts's header comment.
 */
