/**
 * Matching BGE Shadow Service Express app - Tier 0 (Batch 28). Mirrors matching-reasoning-service's
 * middleware ordering and security defaults exactly, minus auth middleware - this service has no
...
app.use(express.json({ limit: '5mb' })); // existingRanked can carry many candidates' feature data
