...
const EXPECTED_TABLES: ExpectedTable[] = [
  {
    ...
    columns: [
      ...
      { name: 'company_id', dataType: 'integer', nullable: true },
      { name: 'source_type', dataType: 'character varying', nullable: false },
      { name: 'source_id', dataType: 'integer', nullable: false },
      { name: 'content', dataType: 'text', nullable: false },
      { name: 'embedding', dataType: 'ARRAY', nullable: false },
...
const EXPECTED_INDEXES: string[] = ['idx_knowledge_base_chunks_company', 'idx_knowledge_base_chunks_source'];
