/**
 * The Gateway's microservices-only routing table.
 * Every path is matched explicitly and forwarded to its owning service;
 * the monolith fallback is removed as of 2026-08-13.
 *
...
export function mountProxyRoutes(app: Express): void {
  ...
  // Default 404 — no fallback, 100% microservices
