 ...
 * (byte-identical), the single function matchRoleByTitle needs. Calls
 * python-services/matching-ml-service directly, never through the monolith, same as every prior
 * batch's own copy.
 */
