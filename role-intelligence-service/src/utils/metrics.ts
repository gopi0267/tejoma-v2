...
// registry, plus a business-specific series for calls to the shared Python embedding service.
import client from 'prom-client';
import type { Request, Response, NextFunction } from 'express';

export const registry = new client.Registry();
registry.setDefaultLabels({ service: 'role-intelligence-service' });
...
export const embeddingServiceCount = new client.Counter({
  name: 'role_intelligence_service_embedding_calls_total',
