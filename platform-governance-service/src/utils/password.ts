// Ported exactly from the monolith's src/utils/password.ts (same copy identity-service carries) -
// same library, same thresholds, same error message shape, so a password rejected by the
// monolith/identity-service today is rejected identically here.
