/**
 * Recruiting Service Express app - Tier 0 (Batch 19). Mirrors every other Tier 0 service's
...
import recruiterNotificationsRoutes from './routes/recruiterNotifications.routes.js';
...
app.use('/api', recruiterNotificationsRoutes);
