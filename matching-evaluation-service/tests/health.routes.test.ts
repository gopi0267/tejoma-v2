/**
 * Integration tests for the health/readiness/liveness endpoints - mirrors candidate-service's/
 * recruiting-service's tests/health.routes.test.ts (this service owns a real database, so
...
describe('GET /health', () => {
  it('reports service identity and a timestamp', async () => {
    ...
    expect(res.body.service).toBe('matching-evaluation-service');
