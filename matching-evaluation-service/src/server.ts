/**
 * Matching Evaluation Service Express app - Tier 0 (Batch 24). Mirrors every other Tier 0
 * service's middleware ordering and security defaults exactly.
 *
...
import shadowAnalyticsRoutes from './routes/shadowAnalytics.routes.js';
...
app.use(express.json({ limit: '5mb' })); // score-batch requests can carry many candidates' feature data
...
app.use('/api', shadowAnalyticsRoutes);
